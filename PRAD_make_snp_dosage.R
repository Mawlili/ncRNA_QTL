...
#plink2 --make-bed   --out bigsnpr   --vcf /rsrch5/home/epi/bhattacharya_lab/projects/ncRNA_QTL/vcf/PRAD/PRAD_merged_renamed_filtered.vcf.gz
...
# read in data
snp_data_file <- bigsnpr::snp_readBed("/rsrch5/home/epi/bhattacharya_lab/projects/ncRNA_QTL/PRAD_bigsnpr/bigsnpr.bed")
snp_data <- readRDS(snp_data_file)
covar <- readr::read_tsv("/rsrch5/home/epi/bhattacharya_lab/projects/ncRNA_QTL/PRAD_qtl/input/short_cov_overlap_V250.txt",
                         col_names = TRUE)[,-1]
#load(biomart_file)
...
saveRDS(sub_snp_data,
        file = "/rsrch5/home/epi/bhattacharya_lab/projects/ncRNA_QTL/PRAD_qtl/snp_dosage.RDS",
        compress = TRUE)
